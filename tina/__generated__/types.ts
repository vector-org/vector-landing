...
export type PostBodyImageBlockFilter = {
  src?: InputMaybe<ImageFilter>;
  alt?: InputMaybe<StringFilter>;
  caption?: InputMaybe<StringFilter>;
};

export type PostBodyVideoBlockFilter = {
...
export type PostBodyFilter = {
  ImageBlock?: InputMaybe<PostBodyImageBlockFilter>;
  VideoBlock?: InputMaybe<PostBodyVideoBlockFilter>;
};
...
export type PostPartsFragment = { __typename: 'Post', title: string, description: string, date: string, author: string, coverImage?: string | null, tags?: Array<string | null> | null, published?: boolean | null, body?: any | null };
...
export type PostQuery = { __typename?: 'Query', post: { __typename: 'Post', id: string, title: string, description: string, date: string, author: string, coverImage?: string | null, tags?: Array<string | null> | null, published?: boolean | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export type PostConnectionQuery = { __typename?: 'Query', postConnection: { __typename?: 'PostConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean, startCursor: string, endCursor: string }, edges?: Array<{ __typename?: 'PostConnectionEdges', cursor: string, node?: { __typename: 'Post', id: string, title: string, description: string, date: string, author: string, coverImage?: string | null, tags?: Array<string | null> | null, published?: boolean | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } | null } | null> | null } };
...
export const ExperimentalGetTinaClient = () =>
  getSdk(
    generateRequester(
      createClient({
        url: `https://content.tinajs.io/1.6/content/${process.env.NEXT_PUBLIC_TINA_CLIENT_ID}/github/main`,
        queries,
      })
    )
  )
